...
module.exports = {
	...
	donate: trimMessage(`
		...
		Поддерживая бота на сумму более 50₽ вы получаете доступ к Premium-функциям. Подробнее /premium.
	`),
	hints: trimMessage(`
		...
		💡 Чтобы показать в инлайн режиме только картинки, гифки или видео, начните запрос с photo, gif, video или sticker соответственно.
		...
		💡 Бот не поддерживает никакие другие типы данных, кроме картинок, гифок, видео и стикеров.
	...
	`),
	most_used_file: "🔝 Ваша самая любимая сохраненка. Вы использовали ее count",
	...
	move_failed: "❌ Не удалось перенести файлы. Cвяжитесь с автором бота @mikhailsdv.",
	move_same_account:
	...
	become_premium: trimMessage(`
		...
		Чтобы стать Premium, поддержите бота на сумму более 50₽.
