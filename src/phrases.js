...
module.exports = {
	...
	start: trimMessage(`
		👋 Привет. Я помогу быстро находить любимые *картинки, видео, гифки, стикеры, документы, аудио и голосовые* — будем называть их «файлы». Вот, как это работает:
	...
	`),
	donate: trimMessage(`
		Поддерживая бота на сумму более 49₽ вы получаете доступ к Premium-функциям. Подробнее /premium.
